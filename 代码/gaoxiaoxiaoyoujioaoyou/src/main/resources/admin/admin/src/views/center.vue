  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='兴趣爱好' prop="aihaoTypes">
                 <el-select v-model="ruleForm.aihaoTypes"  placeholder='请选择兴趣爱好'>
                     <el-option
                             v-for="(item,index) in aihaoTypesOptions"
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='yonghu'"  label="个人简介" prop="yonghuContent">
                 <editor
...
// 注册表 用户 的级联表
   ...
   this.$http({
       url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=aihao_types`,
       method: "get"
   }).then(({ data }) => {
       if (data && data.code === 0) {
          this.aihaoTypesOptions = data.data.list;
      } else {
          this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.aihaoTypes)&& 'yonghu'==this.flag){
                             this.$message.error('兴趣爱好不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.yonghuContent)&& 'yonghu'==this.flag){
