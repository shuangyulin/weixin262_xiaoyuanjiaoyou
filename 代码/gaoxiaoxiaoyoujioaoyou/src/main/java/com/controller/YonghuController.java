...
//                            yonghuEntity.setAihaoTypes(Integer.valueOf(data.get(0)));   //兴趣爱好 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //电子邮箱 要改的
//                            yonghuEntity.setYonghuContent("");//详情和图片
    ...
    */
    ...
    public R list(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(false)
            ...
            params.put("aihaoTypes",yonghuService.selectById((Integer)request.getSession().getAttribute("userId")).getAihaoTypes());
        params.put("aaaaaa",request.getSession().getAttribute("userId"));
        // 没有指定排序字段就默认id倒序
